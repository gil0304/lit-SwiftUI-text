...
struct QuizView: View {
  ...
  let quizItems: [QuizItem] = [
    QuizItem(question: "いつも目の前にあるのに、絶対に自分では見ることができないものは？", options: ["空気", "鼻", "未来"], correctAnswerIndex: 1),
    QuizItem(question: "何でも割ることができるのに、絶対に割れないものは？", options: ["約束", "シャボン玉", "氷"], correctAnswerIndex: 0),
    QuizItem(question: "水を入れても重さがまったく変わらないものは？", options: ["穴", "水筒", "ゴム風船"], correctAnswerIndex: 0),
  ]
